        ...
        <div id="home">
            <a href="#contact">
                <img
                    ...
                    style={{
                        transform: `rotate(${textPositionX / 15}deg)`,
                    }}
                />
            </a>
            <h1
            ...
            <h2
                style={{
                    transform: `translateY(${textPositionY / 4}px)`,
                }}>
                Étudiant développeur intégrateur web
            </h2>
            <img className="tronche" src={memoji} alt="memoji" width={350} />
        </div>
    );
}
